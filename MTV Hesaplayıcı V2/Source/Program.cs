...
namespace MtvHesap
{
	class Program
	{
		...
		// Programın başında gelen yükleniyor efektini sağlayan fonksiyon
		static void Yukleniyor()
		{
			for (int i = 0; i <= 100; i++)
			{
				Console.Write($"\r \t \t \t \t Yükleniyor: {i}%   ");
				Thread.Sleep(50);
			}
			Console.ForegroundColor = ConsoleColor.Green;
			daktilo("\r \t \t \t \t Tamamlandı!",50);
			Thread.Sleep(1500);
			Console.ResetColor();
		}
			public static void Main()
		{
			...
			// Yazdıracağımız ascii karakteri tanımladık
...
╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═══╝     ╚═════╝ ╚═╝  ╚═══╝ ╚═════╝ ╚═╝  ╚═╝
			...
			// Consolun başlığını değiştirdik
			Console.Title = ("****  Mtv Hesaplayıcı V2 - Orkun ONUK  ****");
